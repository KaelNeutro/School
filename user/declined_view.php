...
<div class="container"><!--this is used for responsive display in mobile and other devices-->
    ...
    <table class="table table-bordered table-responsive  table-striped" style="table-layout: fixed">
        ...
        $std=$_POST['std'];
        $view_students_query="SELECT c.code, c.request_date, a.name,b.grade,b.education,c.date_answer FROM pendency c INNER JOIN vacancies b ON (c.vacancy = b.code) INNER JOIN school a ON (b.school = a.code) WHERE c.situation='declined' AND c.students='$std'";//select query for viewing students.
