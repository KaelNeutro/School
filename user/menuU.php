                        ...
                        <form role="form" method="post" action="login.php">
                            <fieldset>
                                ...
                                <div class="collapse btn-block" id="menu-std">
                                    ...
                                    <button type="button" class="btn  btn-warning btn-block" onclick="window.location.href='view_std.php'"> View or Remove  </button>
                                ...
                                <button class="btn btn-success btn-block btn-lg" type="button" data-toggle="collapse" data-target="#menu-us" aria-expanded="false" aria-controls="menu-us">
                                 ...
                                 <div class="collapse btn-block" id="menu-us">
                                    ...
                                    <button type="button" class="btn  btn-warning btn-block" onclick="window.location.href='delfulluser.php'"> Remove Account  </button>
