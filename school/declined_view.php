...
<div class="container"><!--this is used for responsive display in mobile and other devices-->
    <?php
    $gradeDB = "SELECT a.grade, a.education FROM vacancies a INNER JOIN pendency b ON (a.code = b.vacancy) WHERE school='$sch_dp' AND b.situation='declined'  ORDER BY a.education, a.grade";
